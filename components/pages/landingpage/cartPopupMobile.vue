<template>
  <div class="bg-white safe-areas h-screen w-full overflow-hidden">
    ...
    <div class="mt-6 pl-4 pr-2 flex flex-col h-full" v-if="cartData.length > 0">
      <div class="overflow-y-scroll flex-1 pr-2">
